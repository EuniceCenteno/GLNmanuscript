...
genus13.top$day <- 13
genus13.top$day <- factor(genus13.top$day)
str(genus13.top)
...
family13.top$day <- 13
family13.top$day <- factor(family13.top$day)
str(family13.top)
...
genus33.top$day <- 33
genus33.top$day <- factor(genus33.top$day)
str(genus33.top)
...
levels(family33.top$family) <- list("Bifidobacteriaceae"="Bifidobacteriaceae(100)", "Clostridiaceae 1"="Clostridiaceae_1(100)",
                                    ...
                                    "Streptococcaceae"="Streptococcaceae(100)", "Veillonellaceae"="Veillonellaceae(100)")
family33.top$day <- 33
family33.top$day <- factor(family33.top$day)
str(family33.top)
## Top 10 family
