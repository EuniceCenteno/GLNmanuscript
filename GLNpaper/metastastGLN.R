...
setwd('~/Desktop/eunice/Glutamine/No.D0/metasts.new/')
...
ggplot(data = data_s13, aes(x=name, y=ave.abundance,  fill=season)) +
  geom_bar(aes(x=name, y=ave.abundance), position= position_dodge(1), stat="identity") +
  theme_test() +
  ...
  theme(axis.text.x = element_text(color="black", size=8.5, face="bold"), axis.title.y = element_text(color="black", size=10, face="bold")) +
...
ggplot(data = data_s33, aes(x=name, y=ave.abundance,  fill=season)) +
  ...
  theme(axis.text.x = element_text(color="black", size=10, face="bold"), axis.title.y = element_text(color="black", size=12, face="bold")) +
  theme(text=element_text(family="Times New Roman"))
###------------------ TREATMENT EFFECT --------------
...
str(mets.trt1)
levels(mets.trt1$treatment) <- list("AB"="A", "GLN"="GLN", "NA"="NAS")
str(mets.trt1)
str(mets.trt1$Genus)
...
str(data_trt13)
data_trt13$treatment <- as.factor(data_trt13$treatment)
levels(data_trt13$treatment) <- list("AB"="AB", "GLN"="GLN", "NA"="NAS")
...
ggplot(data = data_trt13, aes(x=name, y=ave.abundance,  fill=treatment)) +
  geom_bar(aes(x=name, y=ave.abundance, colour="black"), position= position_dodge(1), stat="identity",  alpha=0.7) +
  theme_test() +
...
data_trt33$treatment <- as.factor(data_trt33$treatment)
levels(data_trt33$treatment) <- list("AB"="A", "GLN"="GLN", "NA"="NAS")
